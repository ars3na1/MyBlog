...
CREATE TABLE `blog articles` (
  ...
  `text` text NOT NULL,
  `last edited` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE `country` (
  ...
  `HeadOfState` char(60) CHARACTER SET latin1 NOT NULL,
...
('SMR', 'San Marino', 'Europe', 'Southern Europe', 61.00, 885, 27000, 81.1, 510.00, NULL, 'San Marino', 'Republic', '', 3171, 'SM'),
...
--
-- Indexes for table `blog articles`
--
ALTER TABLE `blog articles`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `last edited` (`last edited`) USING BTREE,
  ADD KEY `Category` (`Category`),
  ADD KEY `title_3` (`title`);
ALTER TABLE `blog articles` ADD FULLTEXT KEY `text` (`text`);
ALTER TABLE `blog articles` ADD FULLTEXT KEY `title_2` (`title`);
...
--
-- Indexes for table `loremipsum_comments`
--
ALTER TABLE `loremipsum_comments`
  ADD KEY `ID` (`ID`);
ALTER TABLE `loremipsum_comments` ADD FULLTEXT KEY `comment` (`comment`);
